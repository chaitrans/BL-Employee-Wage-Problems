...
public class Empwage {
    ...
    Empwage(String companyName, int max_working_hrs, int days_in_month, int wage_per_hr) {
    ...
    public static void main(String[] args) {
        ...
        Empwage e = new Empwage(companyName, max_working_hrs, days_in_month, wage_per_hr);
        e.employeeWage();
    }
